...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::RpcHeader, servicename_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RpcHeader, methodname_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RpcHeader, arglen_),
};
...
const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\006fixbug\"D\n\tRpcHeader\022\023"
  "\n\013serviceName\030\001 \001(\014\022\022\n\nmethodName\030\002 \001(\014\022"
  "\016\n\006arglen\030\003 \001(\rb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcheader_2eproto = {
  &descriptor_table_rpcheader_2eproto_initialized, descriptor_table_protodef_rpcheader_2eproto, "rpcheader.proto", 103,
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  if (this->arglen() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(3, this->_internal_arglen(), target);
  }
