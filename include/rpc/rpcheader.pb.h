...
class RpcHeader :
 ...
 public:
  ...
  // uint32 arglen = 3;
  void clear_arglen();
  ::PROTOBUF_NAMESPACE_ID::uint32 arglen() const;
  void set_arglen(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_arglen() const;
  void _internal_set_arglen(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 arglen_;
...
inline const std::string& RpcHeader::servicename() const {
  // @@protoc_insertion_point(field_get:fixbug.RpcHeader.serviceName)
  return _internal_servicename();
}
inline void RpcHeader::set_servicename(const std::string& value) {
  _internal_set_servicename(value);
  // @@protoc_insertion_point(field_set:fixbug.RpcHeader.serviceName)
}
inline std::string* RpcHeader::mutable_servicename() {
  // @@protoc_insertion_point(field_mutable:fixbug.RpcHeader.serviceName)
...
inline void RpcHeader::set_servicename(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RpcHeader.serviceName)
}
inline void RpcHeader::set_servicename(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:fixbug.RpcHeader.serviceName)
}
inline void RpcHeader::set_servicename(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:fixbug.RpcHeader.serviceName)
}
...
inline std::string* RpcHeader::release_servicename() {
  // @@protoc_insertion_point(field_release:fixbug.RpcHeader.serviceName)
...
inline void RpcHeader::set_allocated_servicename(std::string* servicename) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.RpcHeader.serviceName)
}
...
inline const std::string& RpcHeader::methodname() const {
  // @@protoc_insertion_point(field_get:fixbug.RpcHeader.methodName)
  return _internal_methodname();
}
inline void RpcHeader::set_methodname(const std::string& value) {
  _internal_set_methodname(value);
  // @@protoc_insertion_point(field_set:fixbug.RpcHeader.methodName)
}
inline std::string* RpcHeader::mutable_methodname() {
  // @@protoc_insertion_point(field_mutable:fixbug.RpcHeader.methodName)
...
inline void RpcHeader::set_methodname(std::string&& value) {
  ...
  methodname_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RpcHeader.methodName)
}
inline void RpcHeader::set_methodname(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:fixbug.RpcHeader.methodName)
}
inline void RpcHeader::set_methodname(const void* value, size_t size) {
  ...
  methodname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.RpcHeader.methodName)
}
...
inline std::string* RpcHeader::release_methodname() {
  // @@protoc_insertion_point(field_release:fixbug.RpcHeader.methodName)
...
inline void RpcHeader::set_allocated_methodname(std::string* methodname) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.RpcHeader.methodName)
}

// uint32 arglen = 3;
inline void RpcHeader::clear_arglen() {
  arglen_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::_internal_arglen() const {
  return arglen_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::arglen() const {
  // @@protoc_insertion_point(field_get:fixbug.RpcHeader.arglen)
  return _internal_arglen();
}
inline void RpcHeader::_internal_set_arglen(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  arglen_ = value;
}
inline void RpcHeader::set_arglen(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_arglen(value);
  // @@protoc_insertion_point(field_set:fixbug.RpcHeader.arglen)
}
